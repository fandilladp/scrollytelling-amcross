      ...
      <main className="bg-white w-full" style={{ fontFamily: "trebuchet" }}>
        ...
        <div className="items-center max-w-6xl mx-auto px-10 py-10 mb-80">
          ...
          <p className="text-justify text-xl py-10">
            ...
            down kantor, sehingga proses pelaksanaan proyek menjadi terganggu.
            Keputusan gubernur dari masing-masing provinsi yang mengeluarkan
            aturan ketat untuk penyelenggaraan proses pelatihan juga turut
            menunda pelaksanaan kegiatan dilapangan.
          </p>
        </div>
        <Scrollytelling />
      </main>
